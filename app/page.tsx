        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 border-t border-gray-200 pt-8 mb-12">
            <div className="md:col-span-1">
              ...
              />
              <div className="mt-4">
                <span className="inline-block bg-gray-800 text-white px-3 py-1 text-sm font-medium">Vol.2</span>
              </div>
            </div>
            <div className="md:col-span-2">
              <div className="mb-4">
                ...
                <p className="text-gray-500 text-sm">Published: 24 March, 2025</p>
              </div>
