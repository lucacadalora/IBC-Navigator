      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="lg:col-span-6">
            <h3 className="text-lg md:text-xl font-bold">About Indonesian Business Council</h3>
          ...
          <div className="lg:col-span-3">
            <h3 className="text-lg md:text-xl font-bold">Research Team</h3>
            <p className="mt-3 md:mt-4 text-sm md:text-base text-gray-600">The IBC Institute</p>
            <p className="mt-1 text-sm md:text-base text-gray-600 italic">Research. Collaboration. Impact</p>
          </div>

          {/* Follow Us */}
          <div className="lg:col-span-3">
            <h3 className="text-lg md:text-xl font-bold">Follow Us</h3>
            <div className="mt-3 md:mt-4 flex space-x-4">
            ...
            <p className="mt-3 md:mt-4 text-xs md:text-sm text-gray-600">ibc-institute.id | business-council.id</p>
          </div>
        </div>

        {/* Disclaimer */}
        <div className="mt-8 md:mt-12 rounded-lg bg-gray-50 p-4 md:p-6">
          <div className="flex items-start space-x-3 md:space-x-4">
            <div className="flex-shrink-0 rounded-full border border-gray-200 p-1 mt-1">
              <svg
